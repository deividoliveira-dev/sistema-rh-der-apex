--------------------------------------------------------------------------------
-- SISTEMA RH - DER
-- Script 01: DDL - Criação das tabelas (versão com RH_USUARIOS)
--------------------------------------------------------------------------------
...
CREATE TABLE setores (
    ...
    nome_setor      VARCHAR2(120 CHAR) NOT NULL,
...
CREATE TABLE cargos (
    ...
    nome_cargo      VARCHAR2(80 CHAR) NOT NULL,
    ativo           CHAR(1) DEFAULT 'S' NOT NULL,
...
--------------------------------------------------------------------------------
-- TABELA: RH_USUARIOS (quem acessa o sistema)
--------------------------------------------------------------------------------
CREATE TABLE rh_usuarios (
    ...
    ativo               CHAR(1) DEFAULT 'S' NOT NULL,
    CONSTRAINT uk_rh_usuario_login UNIQUE (login),
    CONSTRAINT ck_rh_usuario_perfil CHECK (perfil IN ('ADMIN','RH','CONSULTA')),
    CONSTRAINT ck_rh_usuario_ativo CHECK (ativo IN ('S','N'))
);
